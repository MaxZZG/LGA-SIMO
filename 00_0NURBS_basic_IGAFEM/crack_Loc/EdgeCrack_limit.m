...
path (path, '~/mosek/6/tools/platform/osx64x86/bin')
...
vtuFile      = '../results/infiniteCrackModeI';
vtuCrackFile = '../results/infiniteCrackModeI-cracked';
...
noGPs         = p; % # of Gauss points along one direction =p+1 if p=1
noGPs1        = p;                                       % =p   if p>1
...
plot (xCr(:,1),xCr(:,2),'-r', 'LineWidth', 2)    
