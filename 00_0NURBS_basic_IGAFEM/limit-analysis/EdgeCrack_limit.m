%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Extended Isogeometric analysis for two dimensional limit analysis of
% linear elastic cracked solids.
%
...
patch('faces',elementV,'vertices',controlPts,'facecolor','g','edgecolor','none');
axis equal, hold on
