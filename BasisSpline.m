...
KntVect{1} = [0 0 0 1 2 2 3 4 5 5 5];
KntVect{1} = [0 0 0 0 1 2 2 2 2];
KntVect{1} = 0:1:8;
...
% text(2.1,0.95,'\itN_{4,2}','FontSize',30,'FontName','Times New Roman');
% text(2.6,0.72,'\itN_{5,2}','FontSize',30,'FontName','Times New Roman');
% text(3.45,0.8,'\itN_{6,2}','FontSize',30,'FontName','Times New Roman');
% text(4.3,0.71,'\itN_{7,2}','FontSize',30,'FontName','Times New Roman');
% text(4.6,0.8,'\itN_{8,2}','FontSize',30,'FontName','Times New Roman');